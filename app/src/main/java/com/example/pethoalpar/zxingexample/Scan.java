...
public class Scan extends Fragment implements ZXingScannerView.ResultHandler{
    ...
    public void checkAlreadyScan(){
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Config.BASE_URL+"seas/student/checkAlreadyScan.php?stud_id="+splited[0]+"&subject_code="+matchedSubject,
...
//    private ImageButton imageButtonEnterID;
//    private ImageButton imageButtonDisplay;
//
...
//
//
//        imageButtonScan = (ImageButton) this.findViewById(R.id.imageButtonScan);
...
//        //String value2 = bundle.getString("sayangg");
//        Intent i = getIntent();
//        dataString = i.getStringExtra("passDataValue");
//        Log.d("hye scan datastring",dataString);
//
//        subjectInfo = i.getStringExtra("passSubjectInfo");
//
//        textViewSubjectCode.setText("");
//        textViewSubjectName.setText(subjectInfo);
//
//
//        imageButtonEnterID = (ImageButton)findViewById(R.id.imageButtonEnterID);
//        imageButtonEnterID.setOnClickListener(this);
//
//        imageButtonDisplay = (ImageButton)findViewById(R.id.imageButtonDisplay);
//        imageButtonDisplay.setOnClickListener(this);
//    }
//
//    @Override
...
//                    if(dataString.equals(splited[i])) {
//                        matchedSubject = splited[i];
//                        //Toast.makeText(this,"Successfully scanned "+splited[0],Toast.LENGTH_LONG).show();
//                    }
//                    else {
//                        //Toast.makeText(this,splited[0]+" does not belong to this examination",Toast.LENGTH_LONG).show();
//                    }
//                }
//                //this.finish();
//
...
//                    @Override
//                    public void onErrorResponse(VolleyError error) {
//                        //Toast.makeText(Scan.this,error.getMessage().toString(),Toast.LENGTH_LONG).show();
//                        //Toast.makeText(Scan.this,"Student does not register for this subject.",Toast.LENGTH_LONG).show();
//                        AlertDialog.Builder Adialog = new AlertDialog.Builder(Scan.this);
...
//            protected Map<String, String> getParams() throws AuthFailureError {
//                Map<String,String> params = new HashMap<String, String>();
//                params.put("stud_id",splited[0]);
//                params.put("subject_code",matchedSubject);
//
//                return params;
//            }
//        };
...
//                                else{
//                                    getData();
//                                    Toast.makeText(Scan.this,"Successfully added "+splited[0],Toast.LENGTH_LONG).show();
//                                }
//
//                            }
//
...
//    @Override
//    public void onClick(View v) {
//        if (v == findViewById(R.id.imageButtonDisplay)){
//            Intent intent = new Intent(this, DisplayResult.class);
//            intent.putExtra("passDataValue2",dataString);
//            startActivity(intent);
//        }
//        else if (v == findViewById(R.id.imageButtonEnterID)){
//            Intent intent = new Intent(this, EnterStudentID.class);
//            intent.putExtra("passDataSubjectCode",dataString);
//            startActivity(intent);
//        }
//
//    }
